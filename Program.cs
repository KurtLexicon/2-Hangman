...
namespace ConsoleApp4
{
    internal class Program
    {
            ...
            while (true)
            {
                ...
                if (!wantsPlay)
                {
                    ...
                    string exitMessage = rounds.Count > 0 ?
                        $"Thanks for playing, you played {rounds.Count} games with {nSuccess} wins, hope you enjoyed!" :
        ...
        class Round
        {
            ...
            readonly string wantedWord = wordList[rnd.Next(wordList.Length)].ToUpper();
